...
programIntroduction:
  ...
  descriptionParagraphs:
    - "{COMPANY_NAME} offers local exclusivity in multi-engine training within roughly 60 to 100 miles of our location. We provide a high-quality, affordable path to earning your multi-engine rating."
...
finalCTA:
  mainImage: "/src/assets/placeholder-dark-clouds-pitcairn-flight-academy-instrument-rating.webp"
  mainImageAlt: "{COMPANY_NAME} Multi-Engine"
  upperheader: "Upgrade Your Certificate"
  title: "Fly Multi-Engine Today"
  descriptionParagraphs:
    - "Don't overpay for older aircraft. Train with {COMPANY_NAME} for the best rates and equipment in the region."
